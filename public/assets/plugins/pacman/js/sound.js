var EATING_SOUND = new buzz.sound([
    "/assets/plugins/pacman/sound/eating.mp3" 
]);
var GHOST_EATEN_SOUND = new buzz.sound([
	"/assets/plugins/pacman/sound/ghost-eaten.mp3" 
]);
var EXTRA_LIFE_SOUND = new buzz.sound([
    "/assets/plugins/pacman/sound/extra-life.mp3" 
]);
var EAT_PILL_SOUND = new buzz.sound([
    "/assets/plugins/pacman/sound/eat-pill.mp3" 
]);
var EAT_FRUIT_SOUND = new buzz.sound([
    "/assets/plugins/pacman/sound/eat-fruit.mp3" 
]);
var EAT_GHOST_SOUND = new buzz.sound([
    "/assets/plugins/pacman/sound/eat-ghost.mp3" 
]);
var SIREN_SOUND = new buzz.sound([
    "/assets/plugins/pacman/sound/siren.mp3" 
]);
var WAZA_SOUND = new buzz.sound([
    "/assets/plugins/pacman/sound/waza.mp3" 
]);
var READY_SOUND = new buzz.sound([
    "/assets/plugins/pacman/sound/ready.mp3" 
]);
var DIE_SOUND = new buzz.sound([
    "/assets/plugins/pacman/sound/die.mp3" 
]);
