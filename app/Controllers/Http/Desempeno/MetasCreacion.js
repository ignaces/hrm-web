...
class MetasCreacion {
    ...
    async creacion ({view,request, response, auth, session}) {
        ...
        var resultPersonaAuto =await api.execApi(request.hostname(),'/Desempeno/Proceso/getDataPersonasCreacionMetas',objAuto);
        ...
        var resultPersonaSupe =await api.execApi(request.hostname(),'/Desempeno/Proceso/getDataPersonasCreacionMetas',objSupe);
        var PersonaSupe =resultPersonaSupe.body.data;
        //console.log(PersonaSupe);
    ...
    async lista ({view,request, response, auth, session}) {
        ...
        var resultColaborador =await api.execApi(request.hostname(),'/Desempeno/Proceso/getDataPersonasCreacionMetas',objColaborador);
        ...
        return view.render('/desempeno/metas/creacion/listaMetas',{datosProceso,etapasProceso,widgets,colaborador});
    }
}
